      ...
      <div className="space-y-4 p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={!isInStock}
            className="ml-auto inline-flex items-center gap-2 rounded-xl bg-[#FDC700] px-4 py-2.5 text-sm font-semibold text-black shadow-sm transition hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-[#FDC700]/50 disabled:cursor-not-allowed disabled:opacity-50"
          >
